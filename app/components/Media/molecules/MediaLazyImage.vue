<template>
  ...
  >
    ...
    >
      <Icon name="solar:image-outline" class="w-8 h-8 text-muted-foreground" />
    </div>
    ...
    >
      <div class="text-center">
        <Icon name="solar:image-broken-outline" class="w-8 h-8 mx-auto mb-2" />
    ...
    >
      <div class="flex items-center gap-2">
        <Icon name="solar:refresh-outline" class="w-4 h-4 animate-spin" />
