        ...
        <template v-else>
          ...
          >
            ...
            <template #cell-requester="{ row }">
              <div class="font-medium">
                {{ row.requester.name }}
                <Icon v-if="row.attachments && row.attachments.length > 0" title="Has Attachments" name="solar:folder-favourite-bookmark-bold-duotone" class="!size-4 text-success shrink-0 ml-1.5" />
              </div>
